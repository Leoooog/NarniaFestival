...
IdUtente BINARY(16) NOT NULL DEFAULT UNHEX(REPLACE(UUID(), '-', '')),
...
IdEvento BINARY(16) NOT NULL DEFAULT UNHEX(REPLACE(UUID(), '-', '')),
...
IdRistorante BINARY(16) NOT NULL DEFAULT UNHEX(REPLACE(UUID(), '-', '')),
Nome VARCHAR(50) NOT NULL,
Descrizione VARCHAR(1024) NOT NULL,
...
IdBuono BINARY(16) NOT NULL DEFAULT UNHEX(REPLACE(UUID(), '-', '')),
...
IdPrenotazione BINARY(16) NOT NULL DEFAULT UNHEX(REPLACE(UUID(), '-', '')),
